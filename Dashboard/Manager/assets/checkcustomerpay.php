<?php 
 ...
 $fetch = mysqli_query($conn,"select * from customer,store,application,payment
 where store.s_id=application.store_id and customer.c_id=application.customer_id and
 store.s_id=application.store_id and payment.store_id=store.s_id and payment.customer_id=customer.c_id");
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#profile-overview">Customer Info</button>
                </li>

                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit">Motor Info</button>
                </li>
               ...
               echo' <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                ...
                <div class="tab-pane fade pt-3 profile-edit" id="profile-settings">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                      <label for="company" class="col-md-4 col-lg-3 col-form-label">Amount Payed</label>
                      <div class="col-md-8 col-lg-9">
                      <textarea name="plate" type="text" class="form-control" id="company" value="">'.$row['amount'].' Frw</textarea>
                      </div>
                    </div>

                    
                    <div class="row mb-3">
                        <label for="company" class="col-md-4 col-lg-3 col-form-label">Payment Type</label>
                        <div class="col-md-8 col-lg-9">
                          <textarea name="pay" type="text" class="form-control" id="company" value="">'.$row['payment_type'].'</textarea>
                        </div>
                      </div>

                          
                      <div class="row mb-3">
                      <label for="company" class="col-md-4 col-lg-3 col-form-label">Prof Of Payment</label>
                      <div class="col-md-8 col-lg-9">
                        <textarea name="statusm" type="text" class="form-control" id="company" value="">'.$row['pay_image'].'</textarea>
                      </div>
                    </div>

                      
                    <div class="row mb-3">
                    <label for="company" class="col-md-4 col-lg-3 col-form-label">Payed Time</label>
                    <div class="col-md-8 col-lg-9">
                      <textarea name="statusm" type="text" class="form-control" id="company" value="">'.$row['pay_time'].'</textarea>
                    </div>
                  </div>

                    <div class="row mb-3">
                      <label for="Country" class="col-md-4 col-lg-3 col-form-label">Motor Status</label>
                      <div class="col-md-8 col-lg-9">
                       <select name="payy" id="gender" class="form-control">
...
<?php 
    ...
    if(isset($_POST['save']))
    {
        ...
        $sql = mysqli_query($conn,"update store,customer,application,payment set store.requ='$k',store.stat='Dane',store.status='$m'
        where store.s_id=application.store_id and customer.c_id=application.customer_id and store.s_id=application.store_id 
        and store.s_id=payment.store_id and customer.c_id=payment.customer_id");
