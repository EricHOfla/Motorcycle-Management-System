...
<?php
          echo"
              ...
              <table class='table datatable'>
                ...
                application,store,customer where customer.c_id=application.customer_id and store.s_id=application.store_id and store.requ='Approved' and store.status='PAID' and store.stat='Normal'");
