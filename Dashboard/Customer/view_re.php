        ...
        <div class="col-lg-12">
          ...
          echo"
              ...
              <table class='table datatable'>
                ...
                where  store.s_id=application.store_id and application.customer_id = '$cid' and store.requ='Pending'");
                while($row = mysqli_fetch_array($fetch))
                {
                 ...
                 ".
                 "<a class='dropdown-item' href=?s_id=".$row['s_id']."><i class='bi bi-cash'></i>PAY</a>"."</td>";
                 "</td>";
