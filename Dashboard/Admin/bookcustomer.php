...
<?php
          echo"
              ...
              <table class='table datatable'>
                ...
                application,store,customer where customer.c_id=application.customer_id and store.s_id=application.store_id and application.stat!='Dane'");
                while($row = mysqli_fetch_array($fetch))
                {
                 ...
                 echo"<td class='text-right'>".
						...
						<a class='dropdown-item' href=chech_customer_upplie.php?c_id=".$row['s_id']."><i class='bi bi-pencil'></i> View</a>".
					"</td>";
            $count = $count + 1; 
          }     
echo"</table>";
