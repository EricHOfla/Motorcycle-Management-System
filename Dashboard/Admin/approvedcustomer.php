              ...
              <table class='table datatable'>
                <thead>  
                  <tr>
                    ...
                    <th scope='col'>Motor Mark</th>
                    <th scope='col'>Motor Price</th>
                    ...
                    $count = 1;  
                $fetch = mysqli_query($conn,"select * from 
                application,store,customer where customer.c_id=application.customer_id
                 and store.s_id=application.store_id and
                 store.requ='Approved' and store.status='NOT PAID' and store.stat='Normal'");
                while($row = mysqli_fetch_array($fetch))
                {
                 ...
                 echo"<td class='text-right'>".
						...
						<a class='dropdown-item' href=checkcustomerpay.php?c_id=".$row['c_id']."><i class='bi bi-pencil'></i> Check</a>";
            $count = $count + 1; 
          }     
echo"</table>";
