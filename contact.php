                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-12 me-auto mb-lg-0 mb-5">
                            ...
                            <p>Best Sales Service is ready to serve you. MCMS is a professional Campany provide quality products to you.</p>
                                ...
                                <div class="consulting-form-body">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <input type="text" name="volunteer-name" id="volunteer-name" class="form-control" placeholder="Mico Myiza" required>
                                        </div>
                                    ...
                                    <select class="form-select form-control" name="job-salary" id="job-salary" aria-label="Default select example">
                                        ...
                                        <option value="1">Sales Motor</option>
                                        <option value="2">Motor Repairs</option>
